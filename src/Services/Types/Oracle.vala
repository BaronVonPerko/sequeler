...
public class Sequeler.Services.Types.Oracle : Object, DataBaseType {
	public string port { set; get; default = "1521"; }
	...
	public string connection_string (Gee.HashMap<string, string> data) {
		...
		return "Server=" + host + ";User Id=" + username + ";Password=" + password + ";Port=" + port + ";Sid=" + sid;
	}
